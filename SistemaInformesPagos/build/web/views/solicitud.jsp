...
<div>
    <div id="contenedor-pdf" class="contenedor borde-visual">
        <form id="formularioPDF">
            ...
            <h2>SOLICITUD</h2>
            <h3>PARA <input type="text" name="titulo" placeholder="Ej. OBTENER CERTIFICADO DE ZONIFICACIÓN" style="width: 400px;"></h3>
            ...
            <p><strong>SOLICITA:</strong> <input type="text" name="solicita" placeholder="¿Qué solicitas específicamente?" style="width: 400px;"></p>
            ...
            <div class="alineado">
                ...
                DNI N° <input type="text" name="dni" placeholder="DNI" style="width: 120px;">, con domicilio en: 
                <input type="text" name="domicilio" placeholder="Dirección completa" style="width: 400px;">, del Distrito de 
                <input type="text" name="distrito" placeholder="Distrito" style="width: 150px;">, Provincia de 
                <input type="text" name="provincia" placeholder="Provincia" style="width: 150px;">, ante Usted respetuosamente me presento y expongo:<br><br>

                Que, <input type="text" name="motivo" placeholder="Motivo de la solicitud" style="width: 500px;">,
                por lo que <span class="negrita">SOLICITO</span> a su despacho tenga a bien ordenar a quien corresponda
                la <input type="text" name="accion_solicitada" placeholder="acción específica solicitada" style="width: 300px;">
                para los fines pertinentes.
                <br><br>
                <!-- Textarea para información adicional -->
                <textarea id="campoAmpliacion" rows="4" placeholder="Información adicional o justificación..." style="width: 100%; font-family: 'Times New Roman', serif; font-size: 16px; border: 1px solid #000; padding: 8px; resize: vertical;"></textarea>
                ...
                Por lo expuesto, pido a Usted acceder a mi solicitud por ser de justicia.<br><br>
